    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Lịch sử điểm danh và thống kê tham gia lớp học
        </p>
      </div>
          ...
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Tổng số buổi</dt>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.attendedClasses}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.absentClasses}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.lateClasses}</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-yellow-600">{stats.lateClasses}</div>
              ...
              {filteredAttendance.length > 0 ? (
                filteredAttendance.map((item, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{item.teacherName}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-4 text-center text-gray-500">
                    {attendance.length === 0 ? 'Không có dữ liệu điểm danh' : 'Không tìm thấy lớp học nào phù hợp'}
                  </td>
                </tr>
              )}
            </tbody>
